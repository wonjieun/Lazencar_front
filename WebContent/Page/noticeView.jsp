	...
	<div id="wrap">
		...
		<div id="container">
			<div class="content-wrap">
				...
				<div class="bodystart">
					<table summary="공지사항 상세 내용" class="boardList-best-view">
					...
					<c:forEach items="${list }" var="i">
						<thead>
							<tr>
								<th scope="col">${i.notTitle }</td>
<!-- 								<th scope="col">[긴급/안내] 그린카 고객센터 연결지연</th> -->
<!-- 								<td scope="date">2018.04.04</td> -->
								<td scope="date">${i.notDate }</td>
							</tr>
						</thead>
						<tbody>							
							<tr class="content notice-view-con">
								<td colspan="2">
									<div class="txt-wrap">
										${i.notContent }
<!-- 										<p>안녕하세요. 그린카 입니다.</p><p>항상 저희 서비스를 이용해주시는 여러분께 감사 드립니다.</p><p>&nbsp;</p><p>현재 그린카 고객센터 연결이 지연되고 있습니다.</p><p>그린카의 고객센터 품질 향상을 위해 새롭게 단장을 준비하던 중,</p><p>상담원과 연결이 원활하지 않은 상황이 발생되었습니다. 죄송합니다.</p><p>&nbsp;</p><p><u>휴대폰의 “APP”또는 “web”으로 <span style="color: rgb(255, 0, 0);">“긴급”</span> 문의를 글로 남겨주시면 신속히 연락을 드리겠습니다.</u></p><p>조속히 고객센터의 원활한 연결이 되도록 최선을 다하겠습니다.</p><p>&nbsp;</p><p>서비스 이용 및 문의에 불편을 드린 점에 대해 다시 한번 죄송한 말씀 전합니다.</p><p>너그러운 양해 부탁 드립니다.</p><p>&nbsp;</p><p>감사합니다. &nbsp;</p> -->
									</div>
								</td>
							</tr>
						</tbody>
