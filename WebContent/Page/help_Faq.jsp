		...
		<div class="bodystart">
			...
			<!-- bodystart 	=========================================컨텐츠 변경가능 영역!!================================================  -->
					...
					<ul class="question-tab">
						...
						<li class='on'><a href="./help_Faq.jsp">BEST 10<!-- (137) --></a></li>
							...
							<li class='last-tab' ><a href="./help_Faq5.jsp">사용/반납<!-- (7) --></a></li>
					...
					<script type="text/javascript">
						...
						<ul class="question-wrap">
							...
							<li>
								<p class="question-list">
									<a href="#" onclick= "SirenFunction('4'); return false;" class="blind_view"> 왕복은 어디에 반납해야 하나요? </a>
								</p>
							...
							<li>
								<p class="question-list">
									<a href="#" onclick= "SirenFunction('5'); return false;" class="blind_view"> 반납 시간이 늦으면 어쩌죠? </a>
								</p>
								<div class="answer" style="display:none;" id= "5">
									<div class="bul_a"><p>다음 사용자 예약건이 대기 중인 상태에서&nbsp;</p><p>반납 시간 지연으로 인한 다음 사용자의 피해가 발생한 경우&nbsp;</p><p>예약 건당 30,000원과 추가 이용료가 과금 될 수 있습니다.&nbsp;</p><p>&nbsp;</p><p>예약 사용 중인 자동차는&nbsp;</p><p>다른 회원이 대기 중이지 않을 경우 연장 사용 신청이 가능하며&nbsp;</p><p>사용 종료 시간으로 부터 10분 단위로 적용됩니다.&nbsp;</p><p>&nbsp;</p><p>사전 통보 없이 반납 시간 연장을 하지 않고&nbsp;</p><p>이용을 하는 경우 회사가 임의로 반납 시간을 연장하여 요금을&nbsp;</p><p>청구 할 수 있습니다.</p><p>&nbsp;</p><p>&nbsp;</p><p>카셰어링에서 정시 반납은 반드시 지켜야 할 중요한 규칙 입니다.</p><p>&nbsp;</p><p>반납 지연 시 다음 예약 회원의&nbsp;</p><p>정상 사용이 어렵게 되며 이러한 컴플레인에 대한 문제는</p><p>라젠카에서 모든 편의를 제공하여야 합니다.</p><p>&nbsp;</p><p>그 과정에서 대차 진행, 택시 등의 운송수단 보상 비용이&nbsp;</p><p>발생하게 되며 회사 측의 이익을 위한 벌금이 아닌 피해 회원들을&nbsp;</p><p>위한 제도인 점을 안내드립니다.</p><p>&nbsp;</p><p>이러한 문제 상황을 피하기 위해&nbsp;</p><p>하기 내용을 참고하시어 이용 부탁 드립니다.</p><p>&nbsp;</p><p>1. 차량 예약 시 운행시간을 고려하여 충분한 시간으로 예약&nbsp;</p><p>&nbsp; &nbsp; 운전시간과 기타 부대시간을&nbsp;</p><p>&nbsp; &nbsp; 모두 포함해서 30분~1시간 여유롭게 예약하시기를 추천 합니다.</p><p>&nbsp;</p><p>2. 정시에 목적지에서 출발</p><p>&nbsp; &nbsp; 차고지 특성에 따라 차량 위치 확인 시간이 소요 될 수 있으며</p><p>&nbsp; &nbsp; 출발/복귀 예상 시간이 다를 수 있기 때문에 충분한 시간을&nbsp;</p><p>&nbsp; &nbsp; 두는 것이 유리합니다.&nbsp;</p><p>&nbsp;</p><p>만약 주행 중에 예약 마감 시간까지&nbsp;</p><p>반납 불가능 시 스마트폰으로 예약을 연장하시거나&nbsp;</p><p>고객센터(080-2000-3000)를 통해 예약 시간을 연장 해 주세요.&nbsp;</p></div>
								</div>
							</li>
						
							<li>
								<p class="question-list">
									<a href="#" onclick= "SirenFunction('6'); return false;" class="blind_view"> 차량 반납은 어떻게 하나요? </a>
								</p>
